        ...
        'Fn::Base64': {
          'Fn::Join': [
            ...
            [
              ...
              {
                Ref: 'AssetParameters95f5b9af7e6bb7ab466d97a46fb388d47cc2708cd61d933d91c43d026b74b164S3Bucket3B23E78C',
              },
              '/',
              {
                'Fn::Select': [
                  0,
                  {
                    'Fn::Split': [
                      '||',
                      {
                        Ref: 'AssetParameters95f5b9af7e6bb7ab466d97a46fb388d47cc2708cd61d933d91c43d026b74b164S3VersionKey891A4353',
                      },
                    ],
                  },
                ],
